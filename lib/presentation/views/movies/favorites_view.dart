    ...
    if ( favoriteMovies.isEmpty ) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            Icon( Icons.favorite_border_outlined, size: 60, color: colors.primary ),
            Text('Ohhh noo!!', style: TextStyle( fontSize: 30, color: colors.primary )),
            const Text('No tienes favoritos', style: TextStyle( fontSize: 20, color: Colors.black45 )),
            const SizedBox(height: 20),
            FilledButton.tonal(
              style: FilledButton.styleFrom(
                backgroundColor: colors.primary, // Cambia el color de fondo
